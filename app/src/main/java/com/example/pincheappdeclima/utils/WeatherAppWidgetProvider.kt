...
import com.example.pincheappdeclima.MainActivity
import com.example.pincheappdeclima.R
import com.example.pincheappdeclima.database.ClimaDao
...
class WeatherAppWidgetProvider : AppWidgetProvider() {
    ...
    private fun updateAppWidget(
        ...
        // Crea un objeto RemoteViews para el diseño del widget.
        ...
        val pendingIntent = PendingIntent.getActivity(
            context,
            appWidgetId, // Usa el ID del widget como requestCode
            intent,
